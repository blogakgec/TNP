  ...
  body {
	...
	<body>
		...
		<ul class="nav nav-tabs" >
  			...
  			<li role="presentation" style="width:150px; text-align:center;" class="active"><a href="workshops.php">Workshops</a></li>
	...
	<?php
		...
		while($query_result= mysqli_fetch_array($query_select,MYSQLI_ASSOC))
		{
			...
			echo "<div class=\"panel panel-default\" id=\"events-pannel\">";
  			...
  			echo $query_result['workshop_name'];
  			echo '<br>';
			echo $query_result['workshop_description'];
